...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_sites_locale" AS ENUM('lv', 'en');
  CREATE TYPE "public"."enum_site_memberships_role" AS ENUM('member', 'member-admin');
  CREATE TYPE "public"."enum_site_memberships_status" AS ENUM('active', 'blocked');
  CREATE TYPE "public"."enum_site_memberships_slide_image_mode" AS ENUM('contain', 'cover');
  CREATE TYPE "public"."enum_site_memberships_attendance_type" AS ENUM('onsite', 'online');
  ...
  CREATE TYPE "public"."enum_audit_logs_action" AS ENUM('user_deleted', 'user_created', 'user_updated', 'superadmin_login', 'superadmin_login_failed', 'membership_created', 'membership_deleted', 'site_created', 'site_deleted');
  CREATE TYPE "public"."enum_audit_logs_target_type" AS ENUM('user', 'site', 'membership');
  ...
  CREATE TYPE "public"."enum_ai_settings_perplexity_model" AS ENUM('sonar-pro', 'sonar');
  CREATE TYPE "public"."enum_ai_settings_model" AS ENUM('gpt-4.1-nano', 'gpt-4o-mini', 'gpt-4.1-mini', 'o3-mini', 'o4-mini', 'gpt-5', 'o3', 'gpt-4.1', 'gpt-4o');
  CREATE TYPE "public"."enum_faq_settings_faqs_category" AS ENUM('general', 'membership', 'meetings', 'referrals', 'events', 'other');
  CREATE TYPE "public"."enum_site_settings_collection_seo_twitter_card" AS ENUM('summary', 'summary_large_image');
  CREATE TYPE "public"."enum_site_settings_collection_schema_organization_type" AS ENUM('Organization', 'LocalBusiness', 'ProfessionalService', 'Corporation');
  ...
  CREATE TABLE "sites" (
  	...
  	"status" "enum_sites_status" DEFAULT 'active',
  	...
  	"include_in_shared_requests" boolean DEFAULT false,
  	"locale" "enum_sites_locale" DEFAULT 'lv',
  ...
  CREATE TABLE "users" (
  	...
  	"admin_hostname" varchar,
  	"current_site_id" varchar,
  	"current_membership_id" varchar,
  	"current_role" varchar,
  	"current_status" varchar,
  	"site_enable_activities" boolean DEFAULT false,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "site_memberships_gallery" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "site_memberships" (
  	...
  	"user_id" integer,
  	"site_id" integer,
  	"role" "enum_site_memberships_role" DEFAULT 'member' NOT NULL,
  	"status" "enum_site_memberships_status" DEFAULT 'active' NOT NULL,
  	"name" varchar,
  	"surname" varchar,
  	"phone" varchar,
  	...
  	"slide_image_mode" "enum_site_memberships_slide_image_mode" DEFAULT 'contain',
  	"company" varchar,
  	...
  	"attendance_type" "enum_site_memberships_attendance_type" DEFAULT 'onsite',
  ...
  CREATE TABLE "ai_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar DEFAULT 'Default AI Configuration' NOT NULL,
  	"enabled" boolean DEFAULT false,
  	"openai_api_key" varchar NOT NULL,
  	"perplexity_api_key" varchar,
  	"perplexity_model" "enum_ai_settings_perplexity_model" DEFAULT 'sonar-pro',
  	"model" "enum_ai_settings_model" DEFAULT 'gpt-4o-mini' NOT NULL,
  	"system_prompt" varchar DEFAULT 'You are an assistant for a professional networking organisation''s member portal. Use the provided tools to look up members, requests and business data before answering. Answer in the same language the user writes in. Stay on topics related to the organisation, its members and their business; politely redirect anything else.' NOT NULL,
  	"max_tokens" numeric DEFAULT 1024 NOT NULL,
  	"temperature" numeric DEFAULT 0.7 NOT NULL,
  	"default_ai_credit_usd" numeric DEFAULT 10 NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "site_settings_collection_admin_emails" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"email" varchar NOT NULL
  ...
  CREATE TABLE "site_settings_collection_schema_same_as" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "site_settings_collection" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_id" integer NOT NULL,
  	"internal_title" varchar,
  	...
  	"seo_twitter_card" "enum_site_settings_collection_seo_twitter_card" DEFAULT 'summary_large_image',
  	"seo_twitter_site" varchar,
  	"seo_google_verification" varchar,
  	"seo_bing_verification" varchar,
  	"seo_robots_txt" varchar,
  	"schema_organization_type" "enum_site_settings_collection_schema_organization_type" DEFAULT 'Organization',
  ...
  ALTER TABLE "power_groups" ADD CONSTRAINT "power_groups_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "users_sessions" ADD CONSTRAINT "users_sessions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "site_memberships_gallery" ADD CONSTRAINT "site_memberships_gallery_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_memberships_gallery" ADD CONSTRAINT "site_memberships_gallery_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_memberships"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "site_memberships" ADD CONSTRAINT "site_memberships_profile_image_id_media_id_fk" FOREIGN KEY ("profile_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_memberships" ADD CONSTRAINT "site_memberships_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_memberships" ADD CONSTRAINT "site_memberships_slide_image_id_media_id_fk" FOREIGN KEY ("slide_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_memberships" ADD CONSTRAINT "site_memberships_power_group_id_power_groups_id_fk" FOREIGN KEY ("power_group_id") REFERENCES "public"."power_groups"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "blog" ADD CONSTRAINT "blog_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_blog_v" ADD CONSTRAINT "_blog_v_version_site_id_sites_id_fk" FOREIGN KEY ("version_site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "special_requests" ADD CONSTRAINT "special_requests_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "top40" ADD CONSTRAINT "top40_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "top20" ADD CONSTRAINT "top20_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "success_stories" ADD CONSTRAINT "success_stories_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "one_to_one_meetings" ADD CONSTRAINT "one_to_one_meetings_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "referrals" ADD CONSTRAINT "referrals_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "event_submissions" ADD CONSTRAINT "event_submissions_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "wiki" ADD CONSTRAINT "wiki_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "wiki_rels" ADD CONSTRAINT "wiki_rels_site_memberships_fk" FOREIGN KEY ("site_memberships_id") REFERENCES "public"."site_memberships"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_wiki_v" ADD CONSTRAINT "_wiki_v_version_site_id_sites_id_fk" FOREIGN KEY ("version_site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_wiki_v_rels" ADD CONSTRAINT "_wiki_v_rels_site_memberships_fk" FOREIGN KEY ("site_memberships_id") REFERENCES "public"."site_memberships"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "homepage_settings" ADD CONSTRAINT "homepage_settings_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "contacts_page_settings_contact_persons" ADD CONSTRAINT "contacts_page_settings_contact_persons_member_id_site_memberships_id_fk" FOREIGN KEY ("member_id") REFERENCES "public"."site_memberships"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "contacts_page_settings" ADD CONSTRAINT "contacts_page_settings_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "about_us_settings" ADD CONSTRAINT "about_us_settings_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "faq_settings" ADD CONSTRAINT "faq_settings_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "site_settings_collection_admin_emails" ADD CONSTRAINT "site_settings_collection_admin_emails_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings_collection"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "site_settings_collection_schema_same_as" ADD CONSTRAINT "site_settings_collection_schema_same_as_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings_collection"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "site_settings_collection" ADD CONSTRAINT "site_settings_collection_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_settings_collection" ADD CONSTRAINT "site_settings_collection_site_logo_id_media_id_fk" FOREIGN KEY ("site_logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_settings_collection" ADD CONSTRAINT "site_settings_collection_favicon16_id_media_id_fk" FOREIGN KEY ("favicon16_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_settings_collection" ADD CONSTRAINT "site_settings_collection_favicon32_id_media_id_fk" FOREIGN KEY ("favicon32_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_settings_collection" ADD CONSTRAINT "site_settings_collection_apple_touch_icon_id_media_id_fk" FOREIGN KEY ("apple_touch_icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_settings_collection" ADD CONSTRAINT "site_settings_collection_favicon192_id_media_id_fk" FOREIGN KEY ("favicon192_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_settings_collection" ADD CONSTRAINT "site_settings_collection_favicon512_id_media_id_fk" FOREIGN KEY ("favicon512_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_settings_collection" ADD CONSTRAINT "site_settings_collection_seo_default_og_image_id_media_id_fk" FOREIGN KEY ("seo_default_og_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_settings_collection" ADD CONSTRAINT "site_settings_collection_schema_organization_logo_id_media_id_fk" FOREIGN KEY ("schema_organization_logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "sm" ADD CONSTRAINT "sm_member_id_site_memberships_id_fk" FOREIGN KEY ("member_id") REFERENCES "public"."site_memberships"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "sm_cer" ADD CONSTRAINT "sm_cer_member_id_site_memberships_id_fk" FOREIGN KEY ("member_id") REFERENCES "public"."site_memberships"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "slideshow_settings_collection" ADD CONSTRAINT "slideshow_settings_collection_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "slideshow_settings_collection_rels" ADD CONSTRAINT "slideshow_settings_collection_rels_site_memberships_fk" FOREIGN KEY ("site_memberships_id") REFERENCES "public"."site_memberships"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "listing_pages_seo" ADD CONSTRAINT "listing_pages_seo_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "companies_page_settings" ADD CONSTRAINT "companies_page_settings_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_ai_settings_fk" FOREIGN KEY ("ai_settings_id") REFERENCES "public"."ai_settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_site_settings_collection_fk" FOREIGN KEY ("site_settings_collection_id") REFERENCES "public"."site_settings_collection"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "power_groups_site_idx" ON "power_groups" USING btree ("site_id");
  ...
  CREATE INDEX "site_memberships_gallery_order_idx" ON "site_memberships_gallery" USING btree ("_order");
  CREATE INDEX "site_memberships_gallery_parent_id_idx" ON "site_memberships_gallery" USING btree ("_parent_id");
  CREATE INDEX "site_memberships_gallery_image_idx" ON "site_memberships_gallery" USING btree ("image_id");
  ...
  CREATE INDEX "site_memberships_role_idx" ON "site_memberships" USING btree ("role");
  CREATE INDEX "site_memberships_status_idx" ON "site_memberships" USING btree ("status");
  CREATE INDEX "site_memberships_name_idx" ON "site_memberships" USING btree ("name");
  CREATE INDEX "site_memberships_surname_idx" ON "site_memberships" USING btree ("surname");
  CREATE INDEX "site_memberships_phone_idx" ON "site_memberships" USING btree ("phone");
  CREATE INDEX "site_memberships_profile_image_idx" ON "site_memberships" USING btree ("profile_image_id");
  CREATE INDEX "site_memberships_logo_idx" ON "site_memberships" USING btree ("logo_id");
  CREATE INDEX "site_memberships_slide_image_idx" ON "site_memberships" USING btree ("slide_image_id");
  CREATE INDEX "site_memberships_company_idx" ON "site_memberships" USING btree ("company");
  CREATE INDEX "site_memberships_company_phone_idx" ON "site_memberships" USING btree ("company_phone");
  CREATE INDEX "site_memberships_company_email_idx" ON "site_memberships" USING btree ("company_email");
  CREATE INDEX "site_memberships_website_idx" ON "site_memberships" USING btree ("website");
  CREATE INDEX "site_memberships_country_idx" ON "site_memberships" USING btree ("country");
  CREATE INDEX "site_memberships_power_group_idx" ON "site_memberships" USING btree ("power_group_id");
  CREATE INDEX "site_memberships_job_position_idx" ON "site_memberships" USING btree ("job_position");
  CREATE INDEX "site_memberships_org_role_idx" ON "site_memberships" USING btree ("org_role");
  ...
  CREATE INDEX "blog_site_idx" ON "blog" USING btree ("site_id");
  ...
  CREATE INDEX "_blog_v_version_version_site_idx" ON "_blog_v" USING btree ("version_site_id");
  ...
  CREATE INDEX "special_requests_site_idx" ON "special_requests" USING btree ("site_id");
  ...
  CREATE INDEX "top40_site_idx" ON "top40" USING btree ("site_id");
  ...
  CREATE INDEX "top20_site_idx" ON "top20" USING btree ("site_id");
  ...
  CREATE INDEX "success_stories_site_idx" ON "success_stories" USING btree ("site_id");
  ...
  CREATE INDEX "one_to_one_meetings_site_idx" ON "one_to_one_meetings" USING btree ("site_id");
  ...
  CREATE INDEX "referrals_site_idx" ON "referrals" USING btree ("site_id");
  ...
  CREATE INDEX "event_submissions_site_idx" ON "event_submissions" USING btree ("site_id");
  ...
  CREATE INDEX "wiki_site_idx" ON "wiki" USING btree ("site_id");
  ...
  CREATE INDEX "wiki_rels_site_memberships_id_idx" ON "wiki_rels" USING btree ("site_memberships_id");
  ...
  CREATE INDEX "_wiki_v_version_version_site_idx" ON "_wiki_v" USING btree ("version_site_id");
  ...
  CREATE INDEX "_wiki_v_rels_site_memberships_id_idx" ON "_wiki_v_rels" USING btree ("site_memberships_id");
  ...
  CREATE INDEX "ai_settings_updated_at_idx" ON "ai_settings" USING btree ("updated_at");
  CREATE INDEX "ai_settings_created_at_idx" ON "ai_settings" USING btree ("created_at");
  ...
  CREATE INDEX "homepage_settings_site_idx" ON "homepage_settings" USING btree ("site_id");
  ...
  CREATE INDEX "contacts_page_settings_site_idx" ON "contacts_page_settings" USING btree ("site_id");
  ...
  CREATE INDEX "about_us_settings_site_idx" ON "about_us_settings" USING btree ("site_id");
  ...
  CREATE INDEX "faq_settings_site_idx" ON "faq_settings" USING btree ("site_id");
  ...
  CREATE INDEX "site_settings_collection_admin_emails_order_idx" ON "site_settings_collection_admin_emails" USING btree ("_order");
  CREATE INDEX "site_settings_collection_admin_emails_parent_id_idx" ON "site_settings_collection_admin_emails" USING btree ("_parent_id");
  CREATE INDEX "site_settings_collection_schema_same_as_order_idx" ON "site_settings_collection_schema_same_as" USING btree ("_order");
  CREATE INDEX "site_settings_collection_schema_same_as_parent_id_idx" ON "site_settings_collection_schema_same_as" USING btree ("_parent_id");
  CREATE INDEX "site_settings_collection_site_idx" ON "site_settings_collection" USING btree ("site_id");
  CREATE INDEX "site_settings_collection_site_logo_idx" ON "site_settings_collection" USING btree ("site_logo_id");
  CREATE INDEX "site_settings_collection_favicon16_idx" ON "site_settings_collection" USING btree ("favicon16_id");
  CREATE INDEX "site_settings_collection_favicon32_idx" ON "site_settings_collection" USING btree ("favicon32_id");
  CREATE INDEX "site_settings_collection_apple_touch_icon_idx" ON "site_settings_collection" USING btree ("apple_touch_icon_id");
  CREATE INDEX "site_settings_collection_favicon192_idx" ON "site_settings_collection" USING btree ("favicon192_id");
  CREATE INDEX "site_settings_collection_favicon512_idx" ON "site_settings_collection" USING btree ("favicon512_id");
  CREATE INDEX "site_settings_collection_seo_seo_default_og_image_idx" ON "site_settings_collection" USING btree ("seo_default_og_image_id");
  CREATE INDEX "site_settings_collection_schema_schema_organization_logo_idx" ON "site_settings_collection" USING btree ("schema_organization_logo_id");
  CREATE INDEX "site_settings_collection_updated_at_idx" ON "site_settings_collection" USING btree ("updated_at");
  CREATE INDEX "site_settings_collection_created_at_idx" ON "site_settings_collection" USING btree ("created_at");
  ...
  CREATE INDEX "slideshow_settings_collection_site_idx" ON "slideshow_settings_collection" USING btree ("site_id");
  ...
  CREATE INDEX "slideshow_settings_collection_rels_site_memberships_id_idx" ON "slideshow_settings_collection_rels" USING btree ("site_memberships_id");
  CREATE INDEX "listing_pages_seo_site_idx" ON "listing_pages_seo" USING btree ("site_id");
  ...
  CREATE INDEX "companies_page_settings_site_idx" ON "companies_page_settings" USING btree ("site_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_ai_settings_id_idx" ON "payload_locked_documents_rels" USING btree ("ai_settings_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_site_settings_collection_i_idx" ON "payload_locked_documents_rels" USING btree ("site_settings_collection_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "site_memberships_gallery" CASCADE;
  ...
  DROP TABLE "site_settings_collection_admin_emails" CASCADE;
  DROP TABLE "site_settings_collection_schema_same_as" CASCADE;
  DROP TABLE "site_settings_collection" CASCADE;
  ...
  DROP TYPE "public"."enum_site_memberships_status";
  DROP TYPE "public"."enum_site_memberships_slide_image_mode";
  DROP TYPE "public"."enum_site_memberships_attendance_type";
  ...
  DROP TYPE "public"."enum_ai_settings_perplexity_model";
  DROP TYPE "public"."enum_ai_settings_model";
  DROP TYPE "public"."enum_faq_settings_faqs_category";
  DROP TYPE "public"."enum_site_settings_collection_seo_twitter_card";
  DROP TYPE "public"."enum_site_settings_collection_schema_organization_type";
